...
sys.path.append(os.path.join(BASE_DIR, '../models/sampling'))
sys.path.append(os.path.join(BASE_DIR, '../models/interpolation'))
sys.path.append(os.path.join(BASE_DIR, '../models/grouping'))
...
def get_loss(pred, label, num_class=50):
